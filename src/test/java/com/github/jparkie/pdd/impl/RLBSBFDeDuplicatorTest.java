...
public class RLBSBFDeDuplicatorTest {
    ...
    public void testCreateFppLowerBound() {
        RLBSBFDeDuplicator.create(64L, 0);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testCreateFppUpperBound() {
        RLBSBFDeDuplicator.create(64L, 1);
    }

    @Test
    public void testCreate() {
        final RLBSBFDeDuplicator deDuplicator = RLBSBFDeDuplicator.create(64L, 0.03D);
    ...
    public void testConstructorInvalidNumBits() {
        new RLBSBFDeDuplicator(0L, 1);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructorInvalidNumHashFunctions() {
        new RLBSBFDeDuplicator(64L, 0);
    }
    ...
    public void testClassifyDistinct() {
        final RLBSBFDeDuplicator deDuplicator = new RLBSBFDeDuplicator(64L, 2);
    ...
    public void testEstimateFpp() {
        final RLBSBFDeDuplicator deDuplicator = new RLBSBFDeDuplicator(NUM_BITS, 2);
